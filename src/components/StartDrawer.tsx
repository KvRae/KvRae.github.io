...
export default function StartDrawer({ onLogout }: StartDrawerProps) {
    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className="flex items-center justify-center w-12 h-12 bg-gray-800 rounded mr-2 border-2 border-yellow-400"
            >
                <span className="font-bold text-yellow-400 relative text-2xl" >
                    K
            ...
            {/* Drawer */}
            {open && (
                <div className="absolute bottom-16 left-0 w-64 bg-gray-900 rounded shadow-lg p-4 flex flex-col space-y-4">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center justify-start space-x-2 px-3 py-2 bg-gray-700 rounded hover:bg-gray-600 text-white"
                    >
                    ...
                    <button
                        onClick={onLogout}
                        className="flex items-center justify-start space-x-2 px-3 py-2 bg-red-600 rounded hover:bg-red-700 text-white"
                    >
                        <FiPower size={18} />
                        <span>Logout</span>
                    </button>
